...
public class InventoryBar : MonoBehaviour
{
    ...
    private void CreateSlot(int number)
    {
        ...
        // ajuste do tamanho e posi��o do slot
        rectTransform.sizeDelta = new Vector2(60, 60);
        rectTransform.anchoredPosition = Vector2.zero;
        rectTransform.localScale = Vector2.one;

        // atualiza o n�mero do slot
    ...
    private void SelectSlot(int slotNumber)
    {
        ...
        // desativa todos os slots e deixa ativo s� clicado
        slots.ForEach(slot => {
        ...
        // caso n�o exista slot com o n�mero digitado, mant�m o que j� tinha
